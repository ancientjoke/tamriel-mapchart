...
MAINLAND = [
    ...
    # --- Blackwood's south coast, running west to the mouth of the Niben
    (732, 715), (714, 716), (696, 716), (678, 716), (668, 716),
    # --- Niben Bay: east bank, S -> N
    (657, 716), (658, 700), (660, 680), (661, 660), (662, 640), (662, 620),
    (662, 600), (662, 580), (663, 560), (664, 540), (665, 520), (664, 500),
    (665, 480), (665, 460), (663, 440), (661, 425), (658, 412),
    # --- the head of the bay below Lake Rumare
    (649, 406),
    # --- Niben Bay: west bank, N -> S
    (640, 412), (639, 425), (639, 440), (639, 460), (639, 480), (638, 500),
    (637, 520), (636, 540), (635, 560), (634, 580), (632, 600), (630, 620),
    (628, 640), (625, 660), (622, 680), (618, 700), (615, 716),
    # --- Elsweyr, south coast (Topal Bay shore), E -> W
    (600, 716), (584, 714), (568, 712), (552, 710), (536, 712), (520, 716),
    ...
    (162, 362), (152, 357), (145, 348), (144, 338), (148, 329),
    # --- Hammerfell, west coast, S -> N
    (150, 318), (145, 309), (135, 303), (123, 300), (112, 296), (103, 289),
    (98, 279),
...
ISLANDS = {
    ...
    "roscrea_b": [(1098, 78), (1110, 84), (1112, 96), (1102, 102), (1090, 96), (1088, 84)],
    "padomaic_islet": [(1076, 124), (1088, 130), (1086, 142), (1074, 144), (1068, 134)],
    "stros_mkai": [
    ...
    "topal_islet": [(641, 664), (647, 667), (648, 674), (643, 678), (637, 674), (637, 668)],
}
...
RIVERS = [
    ...
    # Rumare -> Niben Bay
    [(641, 366), (648, 382), (650, 394), (649, 406)],
    ...
    # Reed / Argonian delta
    [(742, 596), (730, 626), (720, 656), (710, 686), (700, 716)],
